...
### Upcoming Additions/Contributed Models (Guns)
| Gun | Version | Made by |
|-----|---------|--------|
|UMP45|0.8.0|Mercuriousity and CasualNoLifer|
|MP7|0.8.0|Mercuriousity and CasualNoLifer|
|BFG-50|TBA|Mercuriousity|
|Sawn-off|0.8.0|Lieutenant Howitzer|
|Model 555 O/U|0.8.0|Lieutenant Howitzer|
|Uplander DB|0.8.0|Lieutenant Howitzer|
|Unica 6|TBA|Lieutenant Howitzer|
|Python|0.8.0|Lieutenant Howitzer|
|M1911A1|0.8.0|Lieutenant Howitzer|
|Kolibri|0.8.0|Igggosha|
|PKM|0.8.0|Igggosha|
|Malorian|TBA|Joel McCassidy|
|KSG-12|0.8.0|CasualNoLifer|
|P90 Custom|0.8.0|CasualNoLifer|
|HK-416|TBA|CasualNoLifer|
|TEC-9|TBA|CasualNoLifer|
|PSL|TBA|CasualNoLifer|
|NEOSTEAD|TBA|CasualNoLifer|
|FMG-9|TBA|CasualNoLifer|
|MP5K|TBA|CasualNoLifer|
|SCAR-H|0.8.0|WitherFlint343 and CasualNoLifer|
|DSR-50|0.8.0|WitherFlint343 and CasualNoLifer|
|CZ-75|TBA|WitherFlint343|
|B92|TBA|WitherFlint343|
|GM-60|0.8.0|WitherFlint343|
|Galil ACE|0.8.0|WitherFlint343|
|MP5SD|TBA|WitherFlint343|
|Vector "Mk. II"|0.8.0|WitherFlint343|
|Banshee "Mk. II"|0.8.0|WitherFlint343|
|P250 "Mk II"|0.8.0|WitherFlint343|
|M4A4 Wither|0.8.0|WitherFlint343 and CasualNoLifer|
|M4A4 Casual|0.8.0|WitherFlint343 and CasualNoLifer|
|Golden Hawk|0.9.0|Hobbeswyn and CasualNoLifer|
|Deagle "Mk. II"|0.9.0|Hobbeswyn|
|DP-27|0.9.0|Hobbeswyn|
|Maxim-9|0.9.0|Hobbeswyn|
|Tar-21|0.9.0|Hobbeswyn|
|M249 Custom|0.9.0|Hobbeswyn|
|MP5A4|0.9.0|Hobbeswyn|
|Drakon SR|0.9.0|Hobbeswyn|
|M41A PR|0.9.0|Hobbeswyn|
|Auto 9|0.9.0|Hobbeswyn|
|Barrett M95|0.9.0|Hobbeswyn|
|AA-12|0.9.0|Hobbeswyn|
|AWP|0.9.0|Hobbeswyn|
|G11 "Mk. II"|0.9.0|Hobbeswyn|
|Val "Mk. II"|0.9.0|Hobbeswyn|

### Upcoming Additions/Contributed Models (Other)
| Asset | Version | Made by |
|-----|---------|--------|
|Reflex Scope|TBA|CasualNoLifer|
|Tactical Holo Scope|TBA|Hobbeswyn|
|Tactical Grip|TBA|CasualNoLifer|
|Minimal Angled Grip|TBA|CasualNoLifer|
|Reflex Scope|TBA|CasualNoLifer|
|Compensator|TBA|WitherFlint343|
|Special Silencer (PBS 4)|TBA|CasualNoLifer|
|Reflex Scope|TBA|CasualNoLifer|
|Scrapstock|TBA|unknown|
|Sniper Scope (Super Long Scope)|TBA|VIKTORWOOD|
|Hidden Muzzle Break|TBA|CasualNoLifer|
|Hidden Silencer|TBA|CasualNoLifer|
|Hidden Grip|TBA|CasualNoLifer|
|Hidden Stock|TBA|CasualNoLifer|
|Futuristic Sight|TBA|CasualNoLifer|
|Micro Bullet|0.8.0|Igggosha|
|PKM Heavy Bullet|0.8.0|Igggosha|
