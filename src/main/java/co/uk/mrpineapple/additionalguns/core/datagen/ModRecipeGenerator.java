...
public class ModRecipeGenerator extends RecipeProvider {
    ...
    protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
        ...
        WorkbenchRecipeBuilder.crafting(ItemRegistry.NINE_A_NINE_ONE.get())
                ...
                .addCriterion("has_iron_ingot", hasItem(Tags.Items.INGOTS_IRON))
                .addCriterion("has_sponge", hasItem(Items.SPONGE))
                .build(consumer);
        WorkbenchRecipeBuilder.crafting(ItemRegistry.ACE_OF_SPADES.get())
                ...
                .addCriterion("has_iron_ingot", hasItem(Tags.Items.INGOTS_IRON))
                .addCriterion("has_black_concrete", hasItem(Items.BLACK_CONCRETE))
                .addCriterion("has_white_concrete", hasItem(Items.WHITE_CONCRETE))
                .build(consumer);
        ...
        WorkbenchRecipeBuilder.crafting(ItemRegistry.PP_NINETEEN.get())
                ...
                .addCriterion("has_iron_ingot", hasItem(Tags.Items.INGOTS_IRON))
                .addCriterion("has_black_wool", hasItem(Items.BLACK_WOOL))
                .build(consumer);
        ...
        WorkbenchRecipeBuilder.crafting(ItemRegistry.AMMO_FIVE_FIVE_SIX.get(), 16)
                ...
                .addCriterion("has_iron_nugget", hasItem(Tags.Items.NUGGETS_IRON))
                .addCriterion("has_gold_nugget", hasItem(Tags.Items.NUGGETS_GOLD))
                .addCriterion("has_white_dye", hasItem(Items.WHITE_DYE))
                .build(consumer);
        ...
        WorkbenchRecipeBuilder.crafting(ItemRegistry.AMMO_JCC.get(), 32)
                ...
                .addCriterion("has_gunpowder", hasItem(Tags.Items.GUNPOWDER))
                .addCriterion("has_iron_nugget", hasItem(Tags.Items.NUGGETS_IRON))
                .addCriterion("has_cactus", hasItem(Items.CACTUS))
                .build(consumer);
    }
}
